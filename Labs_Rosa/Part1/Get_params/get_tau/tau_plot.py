...
if UP:
    analog,time_arr,pwm = load_variables("new_tau.txt")
...
if DOWN:
    analog,time_arr,pwm = load_variables("visao_down.txt")
    tau = createArrayTauDown(analog, time_arr)
